...
- Confirmed cases in [Eschweiler](en_geography:town):country
- Confirmed cases in @en_gerography:country
- Coronavirus updated situation
- Coronavirus updated statistics
- Death toll
- Deaths in [Grenada](en_geography:country):country
...
- How many cases are registered in [Neuruppin](en_geography:town):country so far?
...
- What is the number of deaths in [Murmansk](en_geography:town):country.
...
- statistics today for [Obernburg Am Main](en_geography:town):country
...
- Deaths in [Groenlândia](en_country_code:GL).
- How many deaths are in [São Pedro e Miquelon](en_country_code:PM)?
- How many deaths can you count in the [Hagere Ertra](en_country_code:ER) alone?
- How many deaths in [België](en_country_code:BE)?
- How many died in [Republic of Honduras](en_country_code:HN)?
- How many people died in [Aolepān Aorōkin Ṃajeḷ](en_country_code:MH)?
- Number of deaths [Pais Kòrsou](en_country_code:CW).
- Number of deaths in [Guão](en_country_code:GU)?
- how many covid 19 death cases in [Republíki ya Kongó](en_country_code:CG)?

## intent:en_covid_situation_infected
- Active cases in [Republic of Armenia](en_country_code:AM).
- How many active cases are in [Bosnia and Herzegovina](en_country_code:BA)?
- How many active cases in [Granada](en_country_code:GD)?
- How many active cases of covid in [Guiana](en_country_code:GY)?
- How many cases in
- How many cases in [Czech Republic](en_country_code:CZ)
- How many coronavirus case are in [Saint Martin (French part)](en_country_code:MF)
- How many infected are in [al-mamlakah al-maghribiyah](en_country_code:MA)?
- How many infected in [Gànnaar](en_country_code:MR)?
- How many people are infected in [República del Paraguay](en_country_code:PY) to this date?
- How many people are infected in [Republic of Chad](en_country_code:TD)?
- How many people are with covid in [Sudan](en_country_code:SD)
- how many positive cases do we have in [Republic of South Sudan](en_country_code:SS)

## intent:en_covid_situation_infected_critical
- Critical cases in [Jarvis Island](en_country_code:UM).
- Critical in [República da Maurícia](en_country_code:MU).
- Critical state [Republic of Armenia](en_country_code:AM).
- Critical state in [Barbados](en_country_code:BB)?
- Critically infected in [Cazaquistão](en_country_code:KZ)?
- Hoe many critically infected in [Swaziland](en_country_code:SZ)?
- How many critical are in [Ellinikí Dimokratía](en_country_code:GR)?
- How many critical cases are in [Heard Island and McDonald Islands](en_country_code:HM)?
- How many critical cases in [Quiribáti](en_country_code:KI)?
- How many critically infected in [Estados Unidos Mexicanos](en_country_code:MX)?
- How many people are in a critical state [Filasṭīn](en_country_code:PS)?
- How many people are in a critical state in [Sint Maarten](en_country_code:MF)?
- How many people are in serious condition in [Svizzera](en_country_code:CH)
- How many people in critical state in [Panama](en_country_code:PA)?
- Infected in critical state in [U.S. Virgin Islands](en_country_code:VI).
- People in critical case in [Argélia](en_country_code:DZ).
- People in critical state in [República del Ecuador](en_country_code:EC).
- how many seriously infected people there in the [Réewum Senegaal](en_country_code:SN)?

## intent:en_covid_situation_last_update
- "[Syrian Arab Republic](en_country_code:SY) cases and deaths"
- Actualized data in [Marshall Islands](en_country_code:MH).
- Cases actualization.
- Cases update as of today.
- How many infected and deaths in [Kingdom of Thailand](en_country_code:TH).
- How many infected in [República Checa](en_country_code:CZ) to this date.
- Last actualization in [Commonwealth of the Northern Mariana Islands](en_country_code:MP).
- Last actualization of infected in [Bhārat Gaṇarājya](en_country_code:IN).
- Last actualization of infected.
- Last data of deaths in [Republic of Afghanistan](en_country_code:AF).
- Last update in [Grupo de Ilhas Pitcairn](en_country_code:PN).
- Last update of deaths in [Ilhas Bermudas](en_country_code:BM).
- Last update on infected in [Ilhas Caimão](en_country_code:KY).
- Latest reports in [Switzerland](en_country_code:CH).
- New cases and deaths in [Ilhas Marianas Setentrionais](en_country_code:MP).
- New cases in [República de Ruanda](en_country_code:RW).
- Tell me about coronavirus in [Gloriosa República de Vanuatu](en_country_code:VU)?
- Today data in [Lețmō Vabāmō](en_country_code:LV).
- Today update in [Tshād](en_country_code:TD).
- Today’s data in [Republic of Vanuatu](en_country_code:VU).
- Today’s update in [Terres australes et antarctiques françaises](en_country_code:TF).
- What are todays values for [Department of Mayotte](en_country_code:YT)
- i would like to know the current numbers of [al-Jumhūrīyah at-Tūnisīyah](en_country_code:TN)
- situation in [Aṣ-Ṣaḥrā’ al-Gharbīyah](en_country_code:EH)

## intent:en_covid_situation_recovered
- "[République du Rwanda](en_country_code:RW) recoveries."
- How many have recovered in [Samoa Ocidental](en_country_code:WS)?
- How many people have recorvered in [South Georgia and the South Sandwich Islands](en_country_code:GS)?
- How many people recovered in [Trinidad](en_country_code:TT)?
- How many recovered in [Jumhūriyyat Tshād](en_country_code:TD)?
- How many recoveries in [Slovenija](en_country_code:SI)?
- How many recoveries to this date in [Jamhuuriyadda Dimuqraadiga Federaalka Itoobiya](en_country_code:ET)?
- Number of recovered in [Jamhuri ya Muungano wa Tanzania](en_country_code:TZ).
- Number of recoveries in [République centrafricaine](en_country_code:CF).
- Recovered [Território Britânico do Oceano](en_country_code:IO).
- Recovered in [Gámbi](en_country_code:GM).
- Recovered of covid in [DPRK](en_country_code:KP).
- Recoveries in [República da Nicarágua](en_country_code:NI).
- Recoveries of covid in [Spain](en_country_code:ES).
- Total number of recoveries in [U.K.](en_country_code:GB).
- how many recovered there are in [Ratcha-anachak Thai](en_country_code:TH)?

## intent:en_covid_situation_tested
- "[Bosnia–Herzegovina](en_country_code:BA) tested."
- "[Antigua and Barbuda](en_country_code:AG) tests."
- How many in [Uvea mo Futuna](en_country_code:WF) were tested?
- How many people in [Österreich](en_country_code:AT) were tested?
- How many people was tested in [DPR Korea](en_country_code:KP)?
- How many people were tested in [Luxemburgo](en_country_code:LU)?
- How many test in covid 19 in [Republic of the Niger](en_country_code:NE)
- How many tested [Reino de Espanha](en_country_code:ES)?
- How many tested are in [Portuguese Republic](en_country_code:PT)?
- How many tested in [Republika Srbija](en_country_code:RS)?
- How many tests in [República da Áustria](en_country_code:AT)?
- How many tests were made [Reino do Bareine](en_country_code:BH)?
- How many were tested in [Independen Stet bilong Papua Niugini](en_country_code:PG)?
- Tested in [Estado Independente da Samoa](en_country_code:WS).
- Tests in [Trinidad e Tobago](en_country_code:TT)
- Total number of tested in [Estado Independente da Samoa](en_country_code:WS).
- Total number of tests made in [Principado de Andorra](en_country_code:AD).
- Total tested in [Chile](en_country_code:CL).
- Total tests in [Lubnān](en_country_code:LB)?
- What is the number of tested in [Jūng'wàh Yàhnmàhn](en_country_code:MO)?
- how many tests were done in [Republic of Guinea-Bissau](en_country_code:GW)?
